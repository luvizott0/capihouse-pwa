...
export const uploadThemeBackground = (formData: FormData) => client.post<{ url: string }>('/profile/theme-background', formData)
export const resetTheme = () => client.delete<User>('/profile/theme')
